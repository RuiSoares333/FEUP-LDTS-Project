...
- Não se criam tantas disrupções durante o desenvolvimento do projeto.
...
- [RankingState](../src/main/java/berzerk/control/state/RankingState.java)
- [SettingsState](../src/main/java/berzerk/control/state/SettingsState.java)
